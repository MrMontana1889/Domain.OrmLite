...
{
	public class GenericTableRepository<TTableType> : DataTableRepositoryBase<TTableType>, IDomainTableRepository<TTableType> where TTableType : class, IDomainTable
	{
		#region Constructor
